...
module nios_cpu_mm_interconnect_0 (
	...
	wire  [88:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_data_master_agent:rp_data
	...
	wire  [88:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	...
	wire  [89:0] nios2_qsys_0_jtag_debug_module_agent_rf_source_data;                                // nios2_qsys_0_jtag_debug_module_agent:rf_source_data -> nios2_qsys_0_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [89:0] nios2_qsys_0_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_qsys_0_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_qsys_0_jtag_debug_module_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	...
	wire  [89:0] pio_0_s1_agent_rf_source_data;                                                      // pio_0_s1_agent:rf_source_data -> pio_0_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] pio_0_s1_agent_rsp_fifo_out_data;                                                   // pio_0_s1_agent_rsp_fifo:out_data -> pio_0_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [88:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [88:0] nios2_qsys_0_data_master_agent_cp_data;                                             // nios2_qsys_0_data_master_agent:cp_data -> router:sink_data
	...
	wire  [88:0] nios2_qsys_0_instruction_master_agent_cp_data;                                      // nios2_qsys_0_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [88:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_002:sink_data
	...
	wire  [88:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [88:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_004:sink_data
	...
	nios_cpu_mm_interconnect_0_router router_001 (
	...
	nios_cpu_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_cpu_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
