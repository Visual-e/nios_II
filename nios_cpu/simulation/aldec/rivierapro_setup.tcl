...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/nios_cpu_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                              
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_mm_interconnect_0_avalon_st_adapter.v"                  -work avalon_st_adapter                            
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                     -work rsp_mux                                      
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/nios_cpu_mm_interconnect_0_rsp_mux.sv"                           -work rsp_mux                                      
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/nios_cpu_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                                    
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                     -work cmd_mux                                      
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/nios_cpu_mm_interconnect_0_cmd_mux.sv"                           -work cmd_mux                                      
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/nios_cpu_mm_interconnect_0_cmd_demux.sv"                         -work cmd_demux                                    
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/nios_cpu_mm_interconnect_0_router_002.sv"                        -work router_002                                   
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/nios_cpu_mm_interconnect_0_router.sv"                            -work router                                       
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                         -work nios2_qsys_0_jtag_debug_module_agent_rsp_fifo
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                    -work nios2_qsys_0_jtag_debug_module_agent         
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                             -work nios2_qsys_0_jtag_debug_module_agent         
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                               -work nios2_qsys_0_jtag_debug_module_translator    
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/nios_cpu_irq_mapper.sv"                                          -work irq_mapper                                   
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_mm_interconnect_0.v"                                    -work mm_interconnect_0                            
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_pio_0.v"                                                -work pio_0                                        
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_onchip_memory2_0.v"                                     -work onchip_memory2_0                             
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_nios2_qsys_0.v"                                         -work nios2_qsys_0                                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_nios2_qsys_0_jtag_debug_module_sysclk.v"                -work nios2_qsys_0                                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_nios2_qsys_0_jtag_debug_module_tck.v"                   -work nios2_qsys_0                                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_nios2_qsys_0_jtag_debug_module_wrapper.v"               -work nios2_qsys_0                                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_nios2_qsys_0_oci_test_bench.v"                          -work nios2_qsys_0                                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/nios_cpu_nios2_qsys_0_test_bench.v"                              -work nios2_qsys_0                                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_cpu.v"                                                                                                                    
}
